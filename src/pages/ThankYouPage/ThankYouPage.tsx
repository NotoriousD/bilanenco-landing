  ...
  return <div className={css.root}>
    <div className={css.content}>
      ...
      <div className={css.links}>
        <a href="https://t.me/bilanenco" className={css.link}><TelegramIcon /></a>
        <a href="https://instagram.com/bilanenco?igshid=MzRlODBiNWFlZA==" className={css.link}><InstagramIcon /></a>
      </div>
    </div>
  </div>;
}
